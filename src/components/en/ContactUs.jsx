      ...
      <div className=" font-os font-normal justify-center mx-auto w-[400px]   md:w-[1220px] mt-10  text-white">
        ...
        >
          <p>
            ...
            ح هو منصة إلكترونية تقدم أداة لحساب العمر عبر الإنترنت بكل دقة
            وسهولة. باستخدام الموقع، يمكنك معرفة عمرك بالميلادي أو الهجري، عن
            طريق اختيار التقويم الذي تفضله، سواء كان الميلادي أو الهجري، ثم
            إدخال تاريخ ولادتك (اليوم، الشهر، السنة) والضغط على زر "احسب العمر"
