  ...
  return (
    <div className="mt-10 font-os p-6 bg-white w-full">
      ...
      <div className="text-black flex flex-col gap-8 p-2" dir="rtl">
        <p>
          العمر الحالي للأشخاص المولودين في عام ميلادي{" "}
          <span className="text-[#0370A3]"> 2003 </span> أو قبل تاريخ
        ...
        <p>
          العمر الحالي للأشخاص المولودين في عام ميلادي{" "}
          <span className="text-[#0370A3]"> 2003 </span> أو بعد تاريخ
          <span className="text-[#0370A3]" dir="ltr">
            {" "}
            19-11-2024{" "}
          </span>{" "}
          هو <span className="text-[#0370A3]"> 20 سنة </span>.
        </p>
